...
supports receiving and sending all WSJT-X message types up through WSJT-X v3.0.2.

This is meant to be a fairly thin binding API, so familiarity with WSJT-X's
[`NetworkMessage.hpp`](https://github.com/WSJTX/wsjtx/blob/v3.0.2/Network/NetworkMessage.hpp)
is recommended.
